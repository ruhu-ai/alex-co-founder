...
def _collection_ref(name: str):
    ...
    refs = {
        ...
        "memory_source_manifests": client.collection("memory_source_manifests"),
        "memory_settings": client.collection("memory_settings"),
        "memory_control_receipts": client.collection("memory_control_receipts"),
        "memory_deletion_tombstones": client.collection("memory_deletion_tombstones"),
        "memory_deletion_jobs": client.collection("memory_deletion_jobs"),
        "memory_deletion_ledger": client.collection("memory_deletion_ledger"),
        ...
        "onboarding_items": client.collection("onboarding_items"),
